...
void checkButtonLock(){
  if (timer(msBacklight, DELAY_Backlight, false) && DELAY_Backlight!=0){ // Если долго не нажимали не одну кнопку, то выключим подсветку экрана
    lcd.noBacklight();
  }
  if (timer(msBL, DELAY_ButtonLock, false) && Buttonlock==false){ // Если долго не нажимали не одну кнопку, то заблокируем их
    m=0;
    lcd.clear();
    ...
    //---<SETTINGS>
        ...
        //------------
                      case 21:
                        ...
                        if (sSelect){m=2; EEPROM.put(a[a_Ts],  Ts); lcd.clear();}
                      break;    
        ...
        //------------
                      case 31:
                        ...
                        if (sSelect){m=3; EEPROM.put(a[a_D],  D); lcd.clear();}
                      break;
        ...
        //------------
                      case 41:
                        ...
                        if (sSelect){m=4; EEPROM_writeAnything(a[a_ModeAuto], ModeAuto); lcd.clear();}
                      break;
        ...
        //------------
                      case 51:
                        ...
                        if (sSelect){m=5; EEPROM_writeAnything(a[a_RegulatorType], RegulatorType); lcd.clear();}
                      break;
        ...
        //------------
                      case 61:
                        ...
                        if (sSelect){m=6; EEPROM.put(a[a_DELAY_Backlight],  DELAY_Backlight); lcd.clear();}
                      break;
        ...
        //------------
                      case 71:
                        ...
                        if (sSelect){m=7; EEPROM_writeAnything(a[a_RLL], RLL); lcd.clear();}
                      break;
        ...
        //------------
                      case 81:
                        ...
                        if (sSelect){m=8; EEPROM_writeAnything(a[a_Recorded], Recorded); lcd.clear();
