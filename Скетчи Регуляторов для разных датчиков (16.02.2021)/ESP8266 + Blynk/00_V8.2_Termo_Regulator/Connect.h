...
void ConnectBlynk(){
  timerB.disable(IDt_reconnectBlynk); // Выключаем таймер
  ...
  */
  ...
  timerB.enable(IDt_reconnectBlynk); // Включаем таймер
  timerB.restartTimer(IDt_reconnectBlynk); // Перезапускаем таймер
}//ConnectBlynk()
